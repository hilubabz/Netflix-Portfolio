        ...
        <>
            <div className="w-full h-[500px] relative">
                ...
                <div className="absolute left-7 top-1/3 space-y-5">
                    <div className="text-4xl font-bold">UTSARGA MANANDHAR</div>
                    ...
                    <div className="flex space-x-7">
                        <div className="bg-red-700 px-7 py-2 rounded-2xl flex items-center gap-2 cursor-pointer hover:bg-red-800 shadow-md hover:shadow-red-500 ease-in-out duration-[0.4s]">
                            <IoPlaySharp />
                            Resume
                        </div>
                        <div className="bg-black px-7 py-2 rounded-2xl flex items-center gap-2 cursor-pointer shadow-md hover:shadow-white ease-in-out duration-[0.4s]">
                            <FaGithub />
                            GitHub
                        </div>
                    </div>
